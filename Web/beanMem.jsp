...
#loginBtn button {margin-left:5px; height:42px;}
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery3.1.1/jquery.min.js"></script>
  </head>
<body>
  <%
...
<nav><ul>
<li><a href="./beadLogout.jsp">로그아웃</a></li>
    <li><a href="./beadFind.jsp">검색</a></li></ul></nav>
<section>
    <% } %>
</section>
