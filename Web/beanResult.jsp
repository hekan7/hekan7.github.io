...
tr:nth-child(add) Pbackground-color:lightgray;}
...
<header><h2>실습을 환영합니다</h2></header>
  ...
  if(!isNotEmpty(search_select) || !isNotEmpty(stud_search)) {
    response.sendRedirect("./beanFidn.jsp");
  }
  ...
  </serction><footer><p>&copy; 20XX Made by Korea. All right reserved.</p></footer></body></html>
