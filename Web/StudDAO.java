...
public int insertStuduser(String stud_id, String stud_passwd, String stud_name, String stud_phone,
  ...
  String sql="insert into studuser (stud_id, stud_passwd, stud_name, stud_phone, stud_gender, stud_email,
  ...
  public List<StudDTO> findAllStuduser(String stud_search) throws SQLException {
    String sql="select * from studuser where stud_id=? or stud_name=? or stud_email=? or stud_phone=? or stud_gender=? or stud_hobby1=? or stud_hobby2=? or stud_hobby=3?;";
  ...
  public List<StudDTO> findHobbyStuduser(String stud_search) throws SQLException {
    String sql="select * from studuser where stud_hobby1=? or stud_hobby2=? or stud_hobby=3?;";
    List<StudDTO>list=new ArrayList<StudDTO>();
    try {
      conn=DriverManager.getConnection(url,user,pass);
      ps=conn.prepareStatement(sql);
